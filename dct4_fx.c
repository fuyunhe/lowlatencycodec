            ...
            Word32 *workBuffer) /* : size of L */
{
    ...
    pDat_1[1] = L_negate(L_shr_pos(pDat_0[1], 1)); 
    pDat_0[0] = L_shr_pos(pDat_0[0], 1);           
...
/* Last Sin and Cos value pair are the same */
    ...
    pDat_1[0] = L_add(accu1, accu2); 
    pDat_0[1] = L_sub(accu1, accu2); 
