...
#if BTLLC_5MS_MODE
	startfreq[0] = 6;
	subdiv_startfreq = tns_subdiv_startfreq_48k_5ms;// tns_subdiv_startfreq_5ms[BW_cutoff_idx];
	subdiv_stopfreq = tns_subdiv_stopfreq_48k_5ms;// tns_subdiv_stopfreq_5ms[BW_cutoff_idx];
	xLen = shr_pos(xLen, 1);
	maxOrder = 4;
