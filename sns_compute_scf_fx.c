...
/* Smoothing and Pre-emphasis */
    ...
    d3_fx[0]     = Mpy_32_16(L_tmp, lpc_pre_emphasis[fs_idx][0]); 
    ...
    FOR (i = 1; i < n_bands - 1; i++)
    {
        ...
        d3_fx[i]     = Mpy_32_16(L_tmp, lpc_pre_emphasis[fs_idx][i]); 
    ...
    d3_fx[n_bands - 1]     = Mpy_32_16(L_tmp, lpc_pre_emphasis[fs_idx][n_bands - 1]); 
...
/* Log-domain */
    ...
    {
        d4_fx[i] = s_max(nf, BASOP_Util_Log2_16(d3_fx[i], d3_fx_exp[i])); 
    }
