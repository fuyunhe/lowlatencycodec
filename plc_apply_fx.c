                        ...
                        Word8 *scratchBuffer)
{
    ...
    IF (sub(bfi, 1) == 0)
    {
        ...
        case 2:
            ...
            /* call phaseEcu */
            env_stab        = 32767;                  /* 1.0=stable , 0.0=dynamic Q15*/
            ...
            { /* convert pitch lag info at current fs to a normalized fractional bin-frequency   */
               plcAd->PhECU_f0hzLtpBinQ7 = plc_phEcuSetF0Hz_fx(fs_idx, old_pitch_int, old_pitch_fr);  
