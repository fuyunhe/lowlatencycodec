...
/* step = 1.f/(float)(length); */
        if (sub(length, 5) == 0)
        {
            step = 6553 /*1.f/5.f Q15*/; 
        }
        if (sub(length, 10) == 0)
        {
            step = 3276 /*1.f/10.f Q15*/; 
        }
        if (sub(length, 15) == 0)
        {
            step = 2184 /*1.f/15.f Q15*/; 
        }
        if (sub(length, 20) == 0)
        {
            step = 1638 /*1.f/20.f Q15*/; 
        }
        if (sub(length, 30) == 0)
        {
            step = 1092 /*1.f/30.f Q15*/; 
        }
        if (sub(length, 40) == 0)
        {
            step = 819 /*1.f/40.f Q15*/; 
        }
        if (sub(length, 60) == 0)
        {
            step = 546 /*1.f/60.f Q15*/; 
        }
        if (sub(length, 80) == 0)
        {
            step = 409 /*1.f/80.f Q15*/; 
        }
        if (sub(length, 120) == 0)
        {
