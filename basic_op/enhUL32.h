...
#define UL_lshl		L_lshl
#define UL_lshr		L_lshr
#define UL_and		L_and
#define UL_or		L_or
#define UL_xor		L_xor
...
#define UL_deposit_h	L_deposit_h
#define u_extract_h		extract_h
#define u_extract_l		extract_l
...
#define	UL_subNsD(UL_var1, UL_var2)		((UL_var1) - (UL_var2))
#define	UL_addNsD(UL_var1, UL_var2)		((UL_var1) + (UL_var2))
