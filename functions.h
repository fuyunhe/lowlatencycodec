...
void processMdct_fx(LC3_Enc* encoder, Word16 x[], Word16 mem[], Word32 y[], Word16 *y_e, Word8 *scratchBuffer);
...
void ProcessingIMDCT(LC3_Dec* decoder, Word32 y[], Word16 *y_e, Word16 mem[], Word16 *mem_e, Word16 x[], Word16 frame_dms,
...
void processPLCmain_fx(LC3_Dec* decoder, Word16 plcMeth, Word16 *concealMethod, Word16 *nbLostFramesInRow, Word16 bfi, Word16 prev_bfi,
                       Word16 la_zeroes, Word16 x_fx[], Word16 ola_mem[],
